...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 1051200; // 1051200; // @RIZCoin 262800; // Note: actual number of blocks per calendar year with DGW v3 is ~200700 (for example 449750 - 249050)
        consensus.nMasternodePaymentsStartBlock = 1000; // @RIZCoin 1000; // not true, but it's ok as long as it's less then nMasternodePaymentsIncreaseBlock
        consensus.nMasternodePaymentsIncreaseBlock = 120000; // @RIZCoin about '3' month after genis  6 month after geneis
        ...
        consensus.BIP34Height = 1; // @RIZCoin 5000;
        consensus.BIP34Hash = uint256S("0x0000000319f64f5a0d068d82efb8ce0843f20b3a56fee1bf04707ff92fc484d7");
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 30 * 60; // @RIZCoin 24 * 60 * 60; // Monoeci: 1 day
        consensus.nPowTargetSpacing = 1 * 60; // @RIZCoin 2 * 60; // Monoeci: 2 minutes
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nPowKGWHeight = 1; // @RIZCoin 15200; // fast ?
        consensus.nPowDGWHeight = 2; // @RIZCoin 34140; // why fast ?
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nTimeout = 1508025600; // @RIZCoin 1539561600; // Oct 15th, 2018
        ...
        nDefaultPort = 27199 ; // @RIZCoin  24157;
        nMaxTipAge = 60 * 60 * 24 * 30; // @RIZCoin ~144 blocks behind -> 2 x fork detection time, was 24 * 60 * 60 in bitcoin
        nDelayGetHeadersTime = 60 * 60 * 24 * 30;
        nPruneAfterHeight = 10; // @RIZCoin 100000;
	...
	vSeeds.push_back(CDNSSeedData("seed2.rizwave.com", "seed2.rizwave.com"));
	vSeeds.push_back(CDNSSeedData("default.walletnode.net", "default.walletnode.net"));

        // Rizcoin addresses start with 'R'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,60); // @RIZCoin R
