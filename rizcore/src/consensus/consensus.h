...
#ifndef RIZCOIN_CONSENSUS_CONSENSUS_H
#define RIZCOIN_CONSENSUS_CONSENSUS_H
...
static const int COINBASE_MATURITY = 100; // @RIZCoin
...
#endif // RIZCOIN_CONSENSUS_CONSENSUS_H
